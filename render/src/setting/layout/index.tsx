        ...
        <div className="app-content">
          <div className="app-body">
            <div className='item'>
              ...
              <span>
                <input type="radio" value="CSV" checked={this.state.mime === 'CSV'} onChange={this.onChangeMime} />{" CSV "}
                <input type="radio" value="TXT" checked={this.state.mime === 'TXT'} onChange={this.onChangeMime} />{" TXT "}
              </span>
            </div>
            <div className='item'>
            ...
            <div className='submit'>
              <button onClick={this.onSubmit} disabled={this.state.loading}>导出{this.state.loading ? '中...' : ''}</button>
            </div>
          </div>
        </div>
      </div>
